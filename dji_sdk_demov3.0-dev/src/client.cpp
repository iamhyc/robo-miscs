...
#ifdef SIMULATION
        x_input = expect_x - drone->local_position.x; Actual.x =  drone->local_position.x - Start.x;
        y_input = expect_y - drone->local_position.y; Actual.y =  drone->local_position.y - Start.y;
        z_input = expect_z - drone->local_position.z; Actual.z =  drone->local_position.z - Start.z;
#else
        x_input = expect_x - pos.linear.x; Actual.x = pos.linear.x - Start.x;
        y_input = expect_y - pos.linear.y; Actual.y = pos.linear.y - Start.y;
        z_input = expect_z - pos.linear.z; Actual.z = Start.z - pos.linear.z;
#endif
