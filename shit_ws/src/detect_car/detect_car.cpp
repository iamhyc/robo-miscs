...
/////////detect green circle! H:70-100!!  (45 - 55 for light green) (dark green 75 - 85)
...
void solveDistance (Mat frame, RotatedRect rect){
    ...
    model_points.push_back(cv::Point3d(0.0f, 0.45f, 0.0f));        
    model_points.push_back(cv::Point3d(0.45f, 0.45f, 0.0f));        
    model_points.push_back(cv::Point3d(0.45f, 0.0f, 0.0f));  
