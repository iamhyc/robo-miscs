...
int low_hsv_car[3]={66, 50, 50}; // h:60 to 70 for dark green car. need more tests for light and dark green.
int high_hsv_car[3]={74, 255, 255};
int low_hsv_pink[3]={140, 0, 180}; // h:145 to 160 for pink car. need more tests for light and dark green.
int high_hsv_pink[3]={160, 80, 255};
